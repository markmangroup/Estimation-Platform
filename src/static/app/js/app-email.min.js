$(document).ready(function () {
  if ($.app.menu.is_touch_device())
    ...
    if (0 < $(".email-app-sidebar-content").length)
      new PerfectScrollbar(".email-app-sidebar-content");
    if (0 < $(".email-app-list").length)
      new PerfectScrollbar(".email-app-list");
    if (0 < $(".email-app-mail-content-detail").length)
      new PerfectScrollbar(".email-app-mail-content-detail");
  }
  $(".email-application")
    ...
    $(".email-application")
      .find(".compose-sidebar-close-icon")
      .on("click", function () {
        $(".compose-new-mail-sidebar").removeClass("show"),
          $(".app-content-overlay").removeClass("show"),
          $("#compose-form").find("input").val(""),
  ...
  $(window).on("resize", function () {
    1200 < $(window).width() &&
      ($(".app-content-overlay").hasClass("show") &&
        $(".app-content-overlay").removeClass("show"),
      $(".compose-new-mail-sidebar").hasClass("show") &&
        $(".compose-new-mail-sidebar").removeClass("show"),
      $(".email-app-sidebar").hasClass("show") &&
        $(".email-app-sidebar").removeClass("show"));
  });
});
