      ...
      t(this, e),
        ...
        n(this, "initialize", function () {
          ...
          t && i.resultList.setAttribute(t.attribute, t.content),
            ...
            i.resultList.id ||
              (i.resultList.id = r("".concat(i.baseClass, "-result-list-"))),
        ...
        n(this, "destroy", function () {
          document.body.removeEventListener("click", i.handleDocumentClick),
            ...
            i.resultList.removeEventListener(
              "mousedown",
              i.core.handleResultMouseDown
            ),
        ...
        n(this, "handleUpdate", function (t, e) {
          (i.resultList.innerHTML = ""),
            t.forEach(function (t, n) {
              ...
              "string" == typeof o
                ? i.resultList.insertAdjacentHTML("beforeend", o)
                : i.resultList.insertAdjacentElement("beforeend", o);
            }),
            i.input.setAttribute(
              "aria-activedescendant",
              e > -1 ? "".concat(i.baseClass, "-result-").concat(e) : ""
            ),
            i.resetPosition &&
              ((i.resetPosition = !1),
        ...
        n(this, "updateStyle", function () {
          (i.root.dataset.expanded = i.expanded),
            ...
            "below" === i.position
              ? ((i.resultList.style.bottom = null),
                (i.resultList.style.top = "100%"))
              : ((i.resultList.style.top = null),
