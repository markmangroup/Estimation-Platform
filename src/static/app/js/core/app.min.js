                          ...
                          if (response && response.results && Array.isArray(response.results)) {
                              for (var a = 0; a < response.results.length; a++) {
                                ...
                                if (0 <= result.document_number.toLowerCase().indexOf(n) && o < 10) {
                                  t += `<li class="auto-suggestion d-flex align-items-center cursor-pointer"><a href="/opportunity/${result.document_number}/detail" class="d-flex align-items-center justify-content-between w-100 primary"><div class="d-flex align-items-center justify-content-start"><span class="mr-2"></span><span>` +
