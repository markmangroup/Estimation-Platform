!(function (i, r, c) {
    ...
    if (
      (c(i).scroll(function () {
        !(function () {
          var e = c(i).scrollTop();
          60 < e
            ? c("body").addClass("navbar-scrolled")
            : c("body").removeClass("navbar-scrolled"),
            20 < e
              ? c("body").addClass("page-scrolled")
              : c("body").removeClass("page-scrolled");
        })();
      }),
      c(i).on("load", function () {
        ...
        c("nav.header-navbar").addClass(e),
          ...
          0 <
            ...
            ).length && c(".app-sidebar").data("background-color", "black");
        var a = !1;
        ...
        !1 === c.app.nav.initialized && c.app.nav.init({ speed: 300 }),
          ...
          c('a[data-action="expand"]').on("click", function (e) {
            e.preventDefault(),
              ...
              c(this).closest(".card").toggleClass("card-fullscreen");
          }),
          ...
          c('.card .heading-elements a[data-action="collapse"]').on(
            "click",
            function () {
              var e,
        ...
        if (
          ...
          u.hasClass("menu-flipped")
            ? c(".main-menu").css("right", o + "px")
            : c(".main-menu").css("left", o + "px");
        }
        var l = c(".search-input input").data("search");
        c(".nav-link-search").on("click", function () {
          c(this);
          c(this).parent(".nav-search").find(".search-input").addClass("open"),
            c(".search-input input").focus(),
            c(".search-input .search-list li").remove(),
            c(".search-input .search-list").addClass("show");
        }),
          c(".search-input-close i").on("click", function () {
            ...
            e.hasClass("open") &&
              ...
              c(".wrapper").hasClass("show-overlay") &&
                c(".wrapper").removeClass("show-overlay"));
          }),
                      ...
                      success: function (response) {
                          if (response && response.results && Array.isArray(response.results)) {
                              for (var a = 0; a < response.results.length; a++) {
                                var result = response.results[a];
                                if (0 <= result.document_number.toLowerCase().indexOf(n) && o < 10) {
                                  t += `<li class="auto-suggestion d-flex align-items-center cursor-pointer"><a href="/proposal/opportunity/${result.document_number}/detail" class="d-flex align-items-center justify-content-between w-100 primary"><div class="d-flex align-items-center justify-content-start"><span class="mr-2"></span><span>` +
                                       `<i class="ft-grid mr-2"></i>` + result.document_number +
                                       '</span></div></a></li>';
                                  o++;
                                }
                              }
                            ...
                            if ("" === t) {
                              s = '<li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex align-items-center justify-content-start"><span class="mr-2"></span><span>No results found.</span></div></a></li>';
                            }
                            i = t.concat(s);
                            c("ul.search-list").html(i);
                          },
                      error: function () {
                        c(".search-list").html('<li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100"><div class="d-flex align-items-center justify-content-start"><span class="mr-2"></span><span>Error fetching results.</span></div></a></li>');
                      }
                    });
                  } else {
                    c(".wrapper").hasClass("show-overlay") &&
    ...
    c(r).on("click", ".nav-toggle, .menu-toggle, .nav-close", function (e) {
      ...
      c(r).on("click", ".main-menu-footer .footer-toggle", function (e) {
        return (
          e.preventDefault(),
          c(this).find("i").toggleClass("pe-is-i-angle-down pe-is-i-angle-up"),
          c(".main-menu-footer").toggleClass("footer-close footer-open"),
          !1
        );
      }),
      ...
      c(r).ready(function () {
        c(".step-icon").each(function () {
          ...
          0 < e.siblings("span.step").length &&
            ...
            c(this).appendTo(c(this).siblings("span.step")));
        });
      }),
      c(i).resize(function () {
      ...
      c(".dropdown-language + .dropdown-menu .dropdown-item").on(
        "click",
        function () {
          var e = c(this);
    ...
    if (Array.prototype.forEach) {
      ...
      for (o = 0; o < m.length; o++)
        m[o].data("size"),
          m[o].data("color"),
          new Switchery(m[o], { color: "#975AFF" });
    }
    c(".navbar-container .scrollable-container .custom-switch span").on(
      "click",
      function (e) {
        e.stopPropagation();
      }
