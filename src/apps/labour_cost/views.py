...
from apps.proposal.views import ProposalViewMixin
...
class LabourCostList(ProposalViewMixin):
    ...
    render_template_name = "labour_cost/labor_cost_list.html"
...
class LabourCostCreateFromCSVFormView(FormView):
    ...
    template_name = "labour_cost/import_labour_cost.html"
    ...
    def form_valid(self, form):
        ...
        if _response.get("error"):
            ...
            return JsonResponse(
                {
                    "redirect": reverse("labour_cost:labour-cost-list"),
