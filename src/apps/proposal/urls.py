...
urlpatterns = (
    [
        ...
        path("proposal-preview", views.ProposalPreview.as_view(), name="proposal_preview"),
        path(
            "opportunity-details",
            views.OpportunityDetails.as_view(),
        ...
        path(
            "glue-material-list",
            views.GlueListView.as_view(),
            name="glue_material_list",
        ),
        path(
            "final-ready-material-list",
            views.FinalReadyMaterialListView.as_view(),
        ...
        path(
            "motor_fla_calculator",
            views.MotorFLACalculator.as_view(),
            name="motor_fla_calculator",
        ),
        path(
            "pump_flo_calculator",
            views.PumpFLOCalculator.as_view(),
            name="pump_flo_calculator",
        ),
        path(
            "netafim_calculator",
            views.NetafimCalculator.as_view(),
            name="netafim_calculator",
        ),
        path(
            "overlap_pro_calculator",
            views.OverlapProCalculator.as_view(),
            name="overlap_pro_calculator",
        ),
        path(
            "southwire_calculator",
            views.SouthwireCalculator.as_view(),
            name="southwire_calculator",
        ),
        path(
            "paigewire_calculator",
            views.PaigewireCalculator.as_view(),
